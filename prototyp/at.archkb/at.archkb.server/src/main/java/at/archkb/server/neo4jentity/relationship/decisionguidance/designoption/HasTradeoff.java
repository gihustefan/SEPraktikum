...
public class HasTradeoff extends DateRelationship<DesignOption, Tradeoff> {
    ...
    public HasTradeoff(DesignOption startNode, Tradeoff endNode, String description, int ordering, String definitionOver, String definitionUnder) {
    ...
    public HasTradeoff(DesignOption startNode, Tradeoff endNode) {
        super(startNode, endNode);
