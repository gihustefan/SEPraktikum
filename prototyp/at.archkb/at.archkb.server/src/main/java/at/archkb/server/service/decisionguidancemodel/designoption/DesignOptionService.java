package at.archkb.server.service.decisionguidancemodel.designoption;
...
public interface DesignOptionService {
     ...
     */
    @PreAuthorize("hasRole('ROLE_USER') and hasPermission(#idDesignOption, 'at.archkb.server.neo4jentity.node.DesignOption', 'OWNER')")
    ...
    /**
     * Creating A new EffectedGuidanceModel Relation
     *
     * @param idDesignOption Which DesignOption
    ...
    /**
     * Updating existing EffectedGuidanceModel Relation Attributes
     *
     * @param idDesignOption         Which DesignOption
    ...
    /**
     * Deleting an existing EffectedGuidanceModel Relation
     *
     * @param idDesignOption                 Which DesignOption
