package at.archkb.server.service.decisiondocumentation;
...
public interface DecisionDocumentationService {
    ...
    @PreAuthorize("hasRole('ROLE_USER') and hasPermission(#id, 'at.archkb.server.neo4jentity.node.DecisionDocumentationModel', 'OWNER')")
     ...
     */
    @PreAuthorize("hasRole('ROLE_USER') and hasPermission(#idDecisionDocumentationModel, 'at.archkb.server.neo4jentity.node.DecisionDocumentationModel', 'OWNER')")
     ...
     */
    @PreAuthorize("hasRole('ROLE_USER') and hasPermission(#idDecisionDocumentation, 'at.archkb.server.neo4jentity.node.DecisionDocumentation', 'OWNER')")
