 ...
 */
@RestController
@RequestMapping("api/dgm/do/components")
@ResponseBody
public class DOComponentsControllerImpl implements DOCoreDataController {
    @Autowired
    ...
    public List<DesignOptionRelationDto> getCoreData(@PathVariable String titlePartial) {
        return doCoreDataService.getCoreData(titlePartial, Component.class);
    }
}
