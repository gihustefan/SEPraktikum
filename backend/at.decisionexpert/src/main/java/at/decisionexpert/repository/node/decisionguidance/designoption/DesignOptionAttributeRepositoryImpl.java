 ...
 */
@Repository
public class DesignOptionAttributeRepositoryImpl implements DesignOptionAttributeRepository {
    ...
    @Override
    public <T extends CoreData> T save(T designOptionAttribute) {
        return neo4jOperations.save(designOptionAttribute);
    }
}
