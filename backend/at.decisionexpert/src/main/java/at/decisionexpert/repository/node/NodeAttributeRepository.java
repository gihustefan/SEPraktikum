...
public interface NodeAttributeRepository {
     ...
     */
    <T extends Node> Collection<T> findNodeByTitle(String partialTitle, Class<T> attributeClass);
     ...
     */
    <T extends Node> T findNodeById(Long id, Class<T> attributeClass);
    ...
    /**
     * Loading a specific DecisionGuidanceModel Attribute (e.g. Quality Attribute)
     * @param nodeAttribute What Attribute to save
     * @param <T> Type identifier
     * @return A single CoreData given by the id
     */
    <T extends CoreData> T save(T nodeAttribute);
}
