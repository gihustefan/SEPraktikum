...
public class HasEffectedGuidanceModels extends DateRelationship<DesignOption, DecisionGuidanceModel> {
    ...
    public HasEffectedGuidanceModels(DesignOption startNode, DecisionGuidanceModel endNode, String description, int ordering) {
