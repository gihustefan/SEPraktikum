...
public class DGMCoreDataServiceImpl implements DGMCoreDataService {
    ...
    @Override
    public <T extends CoreData> List<DecisionGuidanceModelDesignOptionRelationDto> getDesignOptions(@Size(min = 3) String titlePartial) {
        return dgmCoreDataBusiness.getDesignOptions(titlePartial);
    }
